...
export const tripStops: TripStop[] = [
  ...
  },
  {
    ...
    lat: 24.7131,
    lng: 121.6904,
    highlights: ["양조장 투어", "시음 · 솔리스트 라인업", "투어 후 → 택시로 쑤아오 냉천 (~25분)"],
  ...
  },
  {
    ...
    time: "16:30",
    title: "쑤아오 냉천",
    subtitle: "탄산 기포로 피로 풀기 (카발란에서 택시 ~25분)",
    nameZh: "蘇澳冷泉",
    mrt: "쑤아오신역(蘇澳新站)에서 택시 ~10분",
    phrase: "兩張冷泉門票，謝謝。",
    ...
    lat: 24.5967,
    lng: 121.8512,
    highlights: ["냉천 · 탄산 기포 · 양조장 후 휴식", "수영복/타월 챙기기", "냉천 후 → 택시로 蘇澳新站 (~10분) → 기차"],
  ...
  },
  {
    ...
    time: "17:45",
    title: "蘇澳新站 → 타이베이 (기차)",
    subtitle: "냉천 → (택시 ~10분) → 蘇澳新站 → 기차 ~1시간 30분 → 台北車站",
    nameZh: "蘇澳新站 → 台北車站 (台鐵)",
    ...
    lat: 24.6014,
    lng: 121.847,
    highlights: ["냉천 → 택시로 蘇澳新站 (~10분)", "蘇澳新站에서 台北 방향 자강/거광호 (~1시간 30분)", "닝샤 야시장 시간 맞춰 기차편 확인 (귀로도 미리 예매)"],
