...
export const tripDays: TripDay[] = [
  ...
  },
  {
    ...
    date: "5/16 토",
    title: "이란 카발란 + 쑤아오 냉천",
    mood: "느긋한 조식 → 1916 버스+택시로 이란 데이트립",
    summary: "호텔 조식 → 1916 버스로 이란 환승역 → 택시로 카발란 양조장 → 택시로 이란역 → 구간차로 쑤아오역 → 도보 쑤아오 냉천 → 1879 버스(또는 기차)로 타이베이 복귀 → 닝샤 야시장 → 호텔."
  },
  {
    day: 3,
    date: "5/17 일",
...
export const tripStops: TripStop[] = [
  ...
  },
  {
    ...
    date: "5/16 토",
    time: "10:00",
    title: "타이베이 → 이란 환승역 (1916 버스)",
    subtitle: "시먼 → MRT 1정거장 → 타이베이 버스터미널 4F → 거마란 1916 → 이란 환승역 (~1.5h)",
    nameZh: "西門 → 台北車站 → 台北轉運站 4F → 葛瑪蘭 1916 → 宜蘭轉運站",
    mrt: "시먼역(西門) BL11 → 타이베이역(台北車站) → 台北轉運站 4F",
    phrase: "兩張到宜蘭的票，謝謝。",
    phrasePron: "liǎng zhāng dào Yílán de piào, xièxie",
    phraseHint: "이란행 표 두 장이요",
    category: "transit",
    lat: 25.0506,
    lng: 121.5163,
    highlights: [
      "시먼역 → MRT로 타이베이 메인역 (1정거장)",
      "台北轉運站 4층 → 葛瑪蘭客運 1916번 버스 (이란행)",
      "약 1시간~1시간 반 소요 — 11시 반 전후 이란 환승역 도착",
      "주말은 표 빨리 나감 — 출발 전 줄 서기"
    ],
    prompt: "버스 차창에서 본 풍경이나 들은 노래 한 줄.",
    mapsQuery: "Taipei Bus Station Kamalan 1916"
  },
  {
    id: "yilan-brunch",
    day: 2,
    ...
    time: "12:30",
    title: "이란 로컬 점심",
    subtitle: "우셔빙·육갱 등 이란 명물 (카발란행 택시 타기 전 든든히)",
    nameZh: "宜蘭在地午餐",
    mrt: "이란 환승역(宜蘭轉運站) / 이란역에서 도보",
    phrase: "牛舌餅一份，一碗肉羹。",
  ...
  },
  {
    ...
    time: "14:00",
    title: "카발란 양조장 투어",
    subtitle: "예약 완료, 솔리스트 집중 공략 (이란 환승역에서 택시 ~15-20분)",
    nameZh: "噶瑪蘭威士忌酒廠",
    mrt: "이란 환승역(宜蘭轉運站)에서 택시 ~15-20분 · NTD 250~300",
    ...
    highlights: [
      "양조장 투어 · 시음 · 솔리스트 라인업",
      "이란 환승역 시내버스 배차 길어서 택시 강추 (NTD 250~300)",
      "투어 후 → 양조장 정문 경비실/인포에 택시 콜 부탁 → 이란 기차역으로 (~15-20분)"
    ],
  ...
  },
  {
    ...
    time: "16:30",
    title: "쑤아오 냉천",
    subtitle: "탄산 기포로 피로 풀기 (이란역 → 구간차 → 쑤아오역 → 도보 5분)",
    nameZh: "蘇澳冷泉",
    mrt: "쑤아오역(蘇澳車站)에서 도보 ~5분",
    phrase: "兩張冷泉門票，謝謝。",
    ...
    lng: 121.8512,
    highlights: [
      "양조장 → 택시로 이란역 → 구간차(Local Train)로 쑤아오역 (~30-40분)",
      "쑤아오역 하차 후 도보 5분",
      "연중 22도 천연 탄산천 — 사이다처럼 톡 쏘는 기포",
      "대중탕(수영복/수영모 필수) 또는 개인탕 선택 가능",
      "수영복·타월·수영모 챙기기"
    ],
  ...
  },
  {
    ...
    date: "5/16 토",
    time: "17:45",
    title: "쑤아오 → 타이베이 (1879 버스 / 기차)",
    subtitle: "방법 A 추천: 쑤아오 환승역 → 국광 1879 → 원산/남강 → MRT 시먼",
    nameZh: "蘇澳轉運站 → 國光 1879 → 台北",
    mrt: "쑤아오 환승역(蘇澳轉運站) — 냉천 도보권",
    phrase: "兩張到台北的票，謝謝。",
    phrasePron: "liǎng zhāng dào Táiběi de piào, xièxie",
    phraseHint: "타이베이행 표 두 장이요",
    category: "transit",
    lat: 24.5944,
    lng: 121.8514,
    highlights: [
      "방법 A (추천): 蘇澳轉運站 → 國光客運 1879 → 圓山역(R14) 또는 南港展覽館역(BL23/BR24) 직행 → MRT 시먼역",
      "방법 B (대안): 쑤아오역 → 구간차 → 이란역/자오시역 → 자강호로 환승 → 台北車站 → MRT 시먼역",
      "냉천 → 쑤아오 환승역 도보권 (몇 분)",
      "닝샤 야시장 시간 맞춰 출발 — 버스/기차 시간 미리 확인"
    ],
    prompt: "돌아오는 길에서 오늘(카발란·냉천) 베스트 순간 한 줄.",
    mapsQuery: "Suao Transfer Station Kuo-Kuang 1879"
  },
  {
    id: "ningxia",
    day: 2,
